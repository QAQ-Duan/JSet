...
class Topic(models.Model):
    ...
    location_kind = models.CharField(verbose_name='地点类型', max_length=32,default="闵行校区")
    location = models.CharField(verbose_name='具体地点', max_length=256,default="电院大草坪")
    #t_introduce = models.CharField(verbose_name='帖子简介', max_length=256)
    t_number = models.CharField(verbose_name='活动人数', max_length=16,default="2")
    t_time = models.CharField(verbose_name='活动时间', max_length=64,default="2021-08-17")
    contact_kind = models.CharField(verbose_name="联系方式类型",max_length=64,default="邮箱")
    t_contact = models.CharField(verbose_name='联系方式内容', max_length=64,default="QQ:666666")
